...
% =====================================================================
\section{The modelling frame}
\label{part:frame}

What sits between the physics and the model. This section contains the single most
load-bearing unexamined assumption in the project (\S\ref{sec:splitting}).

% ---------------------------------------------------------------------
\subsection{Operator splitting --- the assumption everything rests on}
\label{sec:splitting}
...
\subsubsection{Why this is the project's foundational assumption}
...
\subsubsection{Consequence 1 --- the split's validity is a physical constraint on
...
\subsubsection{Consequence 2 --- the emulator inherits the split's error, it does not
  fix it}
...
\subsubsection{Consequence 3 --- it makes the problem tractable at all}
...
% ---------------------------------------------------------------------
\subsection{The one-zone approximation --- and the reachable manifold}
\label{sec:onezone}

\subsubsection{What bbq is}
\label{sec:whatisbbq}
...
\subsubsection{The subtlety nobody states}
...
\subsubsection{This is the deepest structural insight in Tier 0}
...
% ---------------------------------------------------------------------
\subsection{The semigroup structure and rollout error}
\label{sec:rollouterror}

\subsubsection{The semigroup property}
\label{sec:semigroup}
...
\subsubsection{Rollout error propagation --- deriving the accumulation trichotomy}
...
% ---------------------------------------------------------------------
\subsection*{Self-check --- the modelling frame}
\addcontentsline{toc}{subsection}{Self-check --- the modelling frame}
