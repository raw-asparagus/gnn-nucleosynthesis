...
% =====================================================================
\section{The physical substrate}
...
% ---------------------------------------------------------------------
\subsection{The thermodynamic state of silicon-burning matter}
\label{sec:thermostate}

\subsubsection{The four pressure components}
...
\subsubsection{Worked example --- box centre
...
\subsubsection{Degeneracy across the box}
...
\subsubsection{The Coulomb coupling parameter
  \texorpdfstring{$\Gamma$}{Gamma} --- and why
  \texorpdfstring{\code{chugunov\_2007}}{chugunov\_2007}}
\label{sec:gamma}
...
\subsubsection{The electron-capture threshold --- a box edge derived from scratch}
...
% ---------------------------------------------------------------------
\subsection{Statistical mechanics you actually need}
\label{sec:statmech}

Three results, one framework. Everything in S3 (detailed balance) and S9 (NSE
and QSE) is a corollary of this chapter.

\subsubsection{Chemical potential and the equilibrium condition}
...
\subsubsection{Nuclear partition functions}
...
\subsubsection{Detailed balance from time reversal}
...
% ---------------------------------------------------------------------
\subsection{Nuclear structure minimum}
\label{sec:nuclearstructure}

\subsubsection{The mass-excess convention --- a real sign trap}
...
\subsubsection{Magic numbers and why \texorpdfstring{\nuc{Ni}{56}}{56Ni} is the
  Si-burning endpoint}
...
\subsubsection{Where the rates actually come from --- and how well they are known}
...
\subsubsection{Two distinct neutrino channels}
...
\subsubsection{Why neutrinos free-stream --- and why that accelerates everything}
...
\subsubsection{\texorpdfstring{$\langle E_\nu\rangle$}{<E nu>} --- an open item to
