...
%  with 0.7.1.
% =====================================================================
\section{The reaction network as a formal object}
\label{part:network}

% ---------------------------------------------------------------------
\subsection{Nuclide bookkeeping}
...
% ---------------------------------------------------------------------
\subsection{Binding energy and why the iron peak exists}
...
\subsubsection{The subtlety to internalize now}
...
% ---------------------------------------------------------------------
\subsection{From number density to molar abundance --- derive
...
% ---------------------------------------------------------------------
\subsection{Why networks integrate \texorpdfstring{$Y$}{Y} and not
  \texorpdfstring{$X$}{X} --- the real reason}
\label{sec:whyY}

\subsubsection{Argument 1 --- \texorpdfstring{$Y$}{Y} is a per-baryon quantity,
...
\subsubsection{Argument 2 --- the constraint stays linear with constant coefficients}
...
% ---------------------------------------------------------------------
\subsection{The electron fraction \texorpdfstring{\Ye{}}{Ye} --- the central
  variable}
\label{sec:ye}
...
\subsubsection{The neutron excess}
...
\subsubsection{What changes \texorpdfstring{\Ye{}}{Ye}}
...
\subsubsection{Why silicon burning drives \texorpdfstring{\Ye{}}{Ye} down --- now
  quantitatively}
\label{sec:yedown}
...
\subsubsection{The lepton ledger}
...
% ---------------------------------------------------------------------
\subsection{The network as a bipartite graph}
\label{sec:bipartite}
...
% ---------------------------------------------------------------------
\subsection{Reaction nomenclature and REACLIB chapters}
...
\subsubsection{Channel notation}
...
\subsubsection{REACLIB chapters}
...
\subsubsection{Two clusters and the bridges between them}
\label{sec:clusters}
...
\subsubsection{A note on energy accounting}
...
% ---------------------------------------------------------------------
\subsection{The timescale hierarchy}
...
\subsubsection{The species destruction timescale}
...
\subsubsection{The hierarchy, at box centre}
\label{sec:hierarchy}
...
\subsubsection{The separation you are tempted to assume does not exist}
\label{sec:nogap}
...
% ---------------------------------------------------------------------
\subsection*{Self-check --- the network as a formal object}
\addcontentsline{toc}{subsection}{Self-check --- the network as a formal object}
...
\S\ref{part:computational}; they appear in that section's self-check instead.
