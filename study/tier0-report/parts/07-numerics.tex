...
% =====================================================================
\section{Numerical analysis prerequisites}
\label{part:numerics}

% ---------------------------------------------------------------------
\subsection{Catastrophic cancellation --- \texorpdfstring{$\kappa$}{kappa} is a
  condition number}
...
\subsubsection{The numbers that follow}
...
\subsubsection{Why this reframes the whole kill-test}
...
% ---------------------------------------------------------------------
\subsection{Conditioning and the rank-revealing subtlety}
...
% ---------------------------------------------------------------------
\subsection{Stiffness, defined properly}
\label{sec:stiffness}
...
\subsubsection{Stiffness and QSE are the same phenomenon}
...
% ---------------------------------------------------------------------
\subsection{Floating point, concretely}
...
% ---------------------------------------------------------------------
\subsection{Newton's method, damping, and globalization}
\label{sec:newton}
...
\subsubsection{Why it fails, specifically here}
...
\subsubsection{Globalization: the fallback that cannot fail}
...
% ---------------------------------------------------------------------
\subsection{ODE error control: what rtol and atol actually promise}
\label{sec:errorcontrol}

Prerequisite for reading \code{fluxes/integrate.py}.

\subsubsection{Local versus global error}
...
\subsubsection{Why atol matters more than usual}
\label{sec:atol}
...
\subsubsection{Dense output and t\_eval}
...
\subsubsection{BDF versus Radau}
\label{sec:bdfradau}
...
% ---------------------------------------------------------------------
\subsection*{Self-check --- numerical analysis}
\addcontentsline{toc}{subsection}{Self-check --- numerical analysis}
