...
0 & Part preamble and prerequisite table & \S\ref{part:substrate} opening \\
...
I   & Part preamble & \S\ref{part:context} opening \\
...
IV   & Part preamble & \S\ref{part:frame} opening \\
...
VII   & Part preamble & \S\ref{part:practice} opening \\
...
\subsection{Relocated self-check items}
