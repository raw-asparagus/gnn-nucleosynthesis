...
% =====================================================================
\part{Astrophysical context}
\label{part:context}

Each link in this chain is a physical claim you should be able to defend.

\begin{aside}
\textbf{Notation, taken on credit.} This part is written throughout in \Ye{},
...
% ---------------------------------------------------------------------
\chapter{The last day of a massive star}
\label{sec:lastday}

\section{The burning sequence}
...
\section{Why this is the regime to emulate}
\label{sec:whyregime}
...
% ---------------------------------------------------------------------
\chapter{What actually determines whether the star explodes}
...
Take as given, and verify in Part~\ref{part:substrate}, that at these
...
\section{Derivation --- \texorpdfstring{$M_{\mathrm{ch}} \propto Y_e^2$}{Mch propto Ye2}}
...
\section{The thermal correction}
...
\section{The observable end of the chain}
...
% ---------------------------------------------------------------------
\chapter{The observational grounding --- how we know \texorpdfstring{\Ye{}}{Ye} matters}
...
% ---------------------------------------------------------------------
\chapter*{Self-check --- astrophysical context}
\addcontentsline{toc}{chapter}{Self-check --- astrophysical context}
