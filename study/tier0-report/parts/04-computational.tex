...
% =====================================================================
\part{The computational problem}
\label{part:computational}

% ---------------------------------------------------------------------
\chapter{Why nuclear networks are the computational bottleneck}
...
\section{The three costs, quantified}
...
% ---------------------------------------------------------------------
\chapter{Softwired networks: the compromise MESA makes}
\label{sec:softwired}
...
\section{The actual shape of the trade-off}
...
\section{The measured consequence}
...
% ---------------------------------------------------------------------
\chapter{Why machine-learning emulation}
\label{sec:whyml}
...
\section{The cost model --- what speedup would actually matter}
\label{sec:costmodel}
...
% ---------------------------------------------------------------------
\chapter{What breaks when an emulator does not conserve}
\label{sec:conservationfailure}

\section{Mode 1 --- accumulation}
...
\section{Mode 2 --- physical inconsistency}
...
\section{Why soft penalties are the wrong fix}
...
% ---------------------------------------------------------------------
\chapter{Why a graph neural network}
\label{sec:whygnn}
...
% ---------------------------------------------------------------------
\chapter{Where conservation is allowed to live}
...
\section{Target B --- and the full projector derivation}
\label{sec:targetB}
...
\section{The critical theorem --- and the documented failure mode}
...
% ---------------------------------------------------------------------
\chapter*{Self-check --- the computational problem}
\addcontentsline{toc}{chapter}{Self-check --- the computational problem}
