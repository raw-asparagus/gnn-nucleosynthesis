...
%          Part I's self-check.
% =====================================================================
\section{ML framing and context}
\label{part:ml}

% ---------------------------------------------------------------------
\subsection{What kind of learning problem this is}
...
% ---------------------------------------------------------------------
\subsection{Message passing, concretely}
...
% ---------------------------------------------------------------------
\subsection{Feature and loss design under 15 decades of dynamic range}
\label{sec:featureloss}

\subsubsection{Inputs first --- the transform that is legal}
...
\subsubsection{Then losses --- where the naive choices all fail}
\label{sec:losses}
...
% ---------------------------------------------------------------------
\subsection{MESA and bbq, concretely}
\label{sec:mesabbq}
...
% ---------------------------------------------------------------------
\subsection{Prior art in network acceleration --- where ML actually sits}
\label{sec:priorart}
...
% ---------------------------------------------------------------------
\subsection*{Self-check --- ML framing}
\addcontentsline{toc}{subsection}{Self-check --- ML framing}
...
\S\ref{sec:obsgrounding}; it appears in \S\ref{part:context}'s self-check
